...
public interface AddressInfoRepository extends JpaRepository<AddressInfoEntity, Long> {
    ...
    public List<AddressInfoEntity> getAddressInfoEntitiesByAllFilter(String city, Integer price, Integer roomAmount, Double overallRating);
    ...
    public List<AddressInfoEntity> getAddressInfoEntitiesByCityAndRoomAmountAndRating(String city, Integer roomAmount, Double overallRating);

    @Query(value = "SELECT a FROM AddressInfoEntity a WHERE a.city = :city AND a.apartmentInfo.overallRating >= :overallRating")
    public List<AddressInfoEntity> getAddressInfoEntitiesByCityAndRating(String city, Double overallRating);
    ...
    public List<AddressInfoEntity> getAddressInfoEntitiesByCityAndPriceAndRating(String city, Integer price, Double overallRating);
